...
export default ({ money = 400, nameOfReceiver }: MoneyProps) => {
        ...
        <View className=" w-full h-full ">
            ...
            >
                ...
                <View className="flex flex-row justify-around items-center">
                    ...
                    >
                        <Text className="text-2xl font-bold text-center m-auto">
                            ×
                        </Text>
                    </Pressable>
                </View>
                ...
                <View>
                    <View className="flex items-center mt-10 mb-10 ">
                        <View className="size-14 bg-red-200 rounded-lg my-2 overflow-hidden">
                            <Image source={require('../../../src/assets/image4.jpg')} className="h-full w-full" />
                        </View>
                        <Text className="text-neutral-400">
                            SENDING TO
                        </Text>
                        <Text className="font-normal text-[20px]">
                            {
                                nameOfReceiver
                            }
                        </Text>
                        <Text className="font-semibold text-[22px] mt-4 ">
                            {`$ ${money}`}
                        </Text>
                    </View>
                </View>
                ...
                <View className="mx-10">
                    ...
                    <View className="my-2">
                        <Pressable className="py-4 border border-blue-400/20 rounded-md bg-blue-500/20 active:scale-105" onPress={() => {
                        ...
                        <Text className="text-center text-sm mt-2">
                            payment powered by <Text className="text-blue-800 font-semibold">solaPay</Text>
                        </Text>
                    </View>
                </View>
                {/* bottom view end */}
...
export const TransactionSuccess = () => {
    return (
        <View className=" m-5 h-full">
            <View className="h-40 w-full bg-green-400">
