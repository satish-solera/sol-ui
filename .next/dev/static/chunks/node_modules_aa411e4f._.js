        ...
        "useDocsSearch.useOnChange": ()=>{
            ...
            async function run() {
                ...
                switch(client.type){
                    case "fetch":
                        {
                            const { fetchDocs } = await __turbopack_context__.A("[project]/node_modules/fumadocs-core/dist/fetch-CiphcAUR.js [app-client] (ecmascript, async loader)");
                            return fetchDocs(debouncedValue, client);
                        }
                    case "algolia":
                        {
                            const { searchDocs } = await __turbopack_context__.A("[project]/node_modules/fumadocs-core/dist/algolia-Dbt0kj8j.js [app-client] (ecmascript, async loader)");
                            return searchDocs(debouncedValue, client);
                        }
                    case "orama-cloud":
                        {
                            const { searchDocs } = await __turbopack_context__.A("[project]/node_modules/fumadocs-core/dist/orama-cloud-yicpgD0c.js [app-client] (ecmascript, async loader)");
                            return searchDocs(debouncedValue, client);
                        }
                    case "orama-cloud-legacy":
                        {
                            const { searchDocs } = await __turbopack_context__.A("[project]/node_modules/fumadocs-core/dist/orama-cloud-legacy-NJTbB19B.js [app-client] (ecmascript, async loader)");
                            return searchDocs(debouncedValue, client);
                        }
                    case "mixedbread":
                        {
                            const { search: search$1 } = await __turbopack_context__.A("[project]/node_modules/fumadocs-core/dist/mixedbread-B0TvOHtt.js [app-client] (ecmascript, async loader)");
                            return search$1(debouncedValue, client);
                        }
                    case "static":
                        {
                            const { search: search$1 } = await __turbopack_context__.A("[project]/node_modules/fumadocs-core/dist/static-C_WBOzek.js [app-client] (ecmascript, async loader)");
                            return search$1(debouncedValue, client);
                        }
                    default:
...
//# sourceMappingURL=node_modules_aa411e4f._.js.map